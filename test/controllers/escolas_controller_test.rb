...
class EscolasControllerTest < ActionController::TestCase
  ...
  test "should create escola" do
    assert_difference('Escola.count') do
      post :create, escola: { cnpj: @escola.cnpj, endereco: @escola.endereco, nome: @escola.nome, telefone: @escola.telefone }
    end
  ...
  test "should update escola" do
    patch :update, id: @escola, escola: { cnpj: @escola.cnpj, endereco: @escola.endereco, nome: @escola.nome, telefone: @escola.telefone }
    assert_redirected_to escola_path(assigns(:escola))
  end
