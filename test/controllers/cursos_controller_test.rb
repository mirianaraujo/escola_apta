...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { carga_horaria: @curso.carga_horaria, descricao: @curso.descricao, nome: @curso.nome }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { carga_horaria: @curso.carga_horaria, descricao: @curso.descricao, nome: @curso.nome }
    assert_redirected_to curso_path(assigns(:curso))
  end
